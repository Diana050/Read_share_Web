...
class Menucontroller extends ChangeNotifier {
  ...
  final GlobalKey<ScaffoldState> _ordersSffoldKey = GlobalKey<ScaffoldState>();
  ...
  GlobalKey<ScaffoldState> get getordersscaffoldKey => _ordersSffoldKey;
  ...
  void controlAllOrdersdMenu() {
    if (!_ordersSffoldKey.currentState!.isDrawerOpen) {
      _ordersSffoldKey.currentState!.openDrawer();
    }
  }
